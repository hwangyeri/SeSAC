...
class BookTable: Object {
    ...
    @Persisted var bookAuthors: String // 도서 작가 (필수)
    ...
    @Persisted var bookMemo: String? // 메모 (옵션)
    
    convenience init(bookTitle: String, bookAuthors: String, bookContents: String, bookPrice: Int, bookSalePrice: Int, bookThumbnail: String, bookURL: String, bookPublisher: String, bookDateTime: Date, bookStatus: String, bookLiked: Bool, bookMemo: String?) {
        self.init()
