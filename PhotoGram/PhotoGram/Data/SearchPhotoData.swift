...
struct CoverPhotoTopicSubmissions: Codable {
    let nature, wallpapers, architectureInterior, colorOfWater: Nature?
    let experimental, texturesPatterns, people, animals: Nature?
